...
.. admonition:: Multiple-Choice Questions — Set 1: Personal Errors
    ...
    3. How can a researcher prevent **personal errors** when measuring volumes?
        ...
        | c. Allow the liquid to settle before reading the meniscus
        | d. Use a digital instrument instead of an analogue one

    4. Why should a researcher practise a technique before taking actual measurements?
    ...
    5. Which action best helps prevent **personal errors** during an experiment?
        ...
        | c. Using a checklist to confirm each step has been completed
        | d. Repeating measurements and calculating the mean
...
.. admonition:: Multiple-Choice Questions — Set 2: Parallax Errors
    ...
    3. How does using a mirrored scale help reduce **parallax error**?
        ...
        | a. It magnifies the scale markings for easier reading
        | b. It allows the needle to be aligned with its reflection to ensure a straight-on reading
        | c. It eliminates the need to reset the instrument to zero
        | d. It prevents environmental conditions from affecting the reading

    4. Why should a researcher mark a fixed standing position when reading a thermometer?
