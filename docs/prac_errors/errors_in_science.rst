...
Here are **5 MCQs aligned directly to your error-type framework** (systematic, random, personal + source classification + correction reasoning). They match your style and difficulty level:
