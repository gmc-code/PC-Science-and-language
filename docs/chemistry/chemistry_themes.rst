...
A good paragraph opener:

- Names the subtopic (e.g., state changes, size changes, shape changes)
...
Chemical reactions are processes where new substances are formed from existing materials. These reactions can be recognised through several observable indicators that show the particles have rearranged into something new. Four common signs of a chemical reaction are permanent colour change, gas being given off, formation of a precipitate, and temperature change. Each indicator provides evidence that a chemical change has occurred.

Permanent colour change is one clear sign that a chemical reaction has taken place. This type of colour change does not reverse when the conditions return to normal, because a new substance has formed. For example, when iron rusts, the grey metal surface turns reddish-brown as iron reacts with oxygen to form iron oxide. The new colour shows that a new substance has been produced.

Gas being given off is another important indicator of chemical change. Bubbles, fizzing, or a noticeable gas release suggest that the reactants have formed a new substance in gas form. A simple example is the reaction between vinegar and bicarbonate of soda, which produces carbon dioxide gas. The rapid bubbling shows that a chemical reaction is occurring.

Formation of a precipitate also signals that a chemical reaction has happened. A precipitate is a solid that appears when two clear solutions react and form an insoluble substance. For instance, when solutions of silver nitrate and sodium chloride are mixed, a white solid called silver chloride forms and settles out. The sudden appearance of this solid indicates the creation of a new substance.

Temperature change is a further sign of chemical reaction, as energy is either released or absorbed when new substances form. The reaction may feel warmer (exothermic) or cooler (endothermic) depending on the energy flow. A common example is the reaction inside instant cold packs, where ammonium nitrate dissolves and absorbs heat, causing the pack to become cold. The temperature shift shows that a chemical change has taken place.

----

Reordering an Information Report on Types of Chemical Reactions
===============================================================

Paragraph 1 — Introduction (Scrambled)
--------------------------------------

- These reactions can be grouped into different types based on how substances rearrange.
- Chemical reactions are processes where new substances are formed.
- Three important types are decomposition, composition, and combustion.
- Each type follows a different pattern of particle change.

Paragraph 2 — Decomposition Reactions (Scrambled)
-------------------------------------------------

- A simple example is hydrogen peroxide breaking down into water and oxygen gas.
- Decomposition reactions occur when one substance splits into two or more simpler substances.
- These reactions often require energy such as heat, light, or electricity.
- The new products show that the original substance has separated into different materials.

Paragraph 3 — Composition Reactions (Scrambled)
-----------------------------------------------

- These reactions involve particles joining together to form a more complex product.
- Composition reactions happen when two or more substances combine to form one new substance.
- The formation of iron oxide from iron and oxygen is a simple example.
- The new substance shows that the reactants have combined into a single compound.

Paragraph 4 — Combustion Reactions (Scrambled)
----------------------------------------------

- A common example is methane burning in oxygen to form carbon dioxide and water.
- Combustion reactions involve a substance reacting rapidly with oxygen.
- These reactions usually release heat, light, or both.
- The energy released shows that a chemical change has taken place.

Information Report: Types of Chemical Reactions
===============================================

Chemical reactions are processes in which substances change into new substances with different properties. These reactions can be grouped into several categories based on how the reactants rearrange. Three important types of chemical reactions are decomposition, composition, and combustion. Each type follows a different pattern of particle rearrangement and produces new materials.

Decomposition reactions occur when one substance breaks down into two or more simpler substances. This type of reaction usually requires energy, such as heat, light, or electricity, to split the original compound apart. A simple example is the decomposition of hydrogen peroxide, which breaks down into water and oxygen gas. The release of oxygen bubbles shows that the original substance has separated into new products.

Composition reactions happen when two or more substances combine to form a single new substance. These reactions involve particles joining together to create a more complex product. An example is the reaction between iron and oxygen to form iron oxide. The new solid that forms shows that the reactants have combined into a single compound.

Combustion reactions involve a substance reacting rapidly with oxygen to release energy. These reactions often produce heat, light, and new substances such as gases or oxides. A common example is the burning of methane gas, which reacts with oxygen to form carbon dioxide and water. The flame and heat produced show that a chemical reaction has occurred.
