...
* **So that** (the primary way to express a functional goal)
* **In order that** (a formal way to express a intended result)
* **To** (the infinitive used to show purpose)
* **So as to** (links an action directly to its intended precision)
* **That** (often follows "ensure" to define the goal)
* **As if** (used to describe a required state of being)
...
* **Since** (marks the starting point in time of a process)
