...
Cause and Effect Conjunctions in Science
-------------------------------------------------

| Scientists use specific words to link a **cause** to an **effect**.
| Using these creates "Complex Sentences" that provide deeper explanations.
...
*Note: These usually link two separate sentences.*
