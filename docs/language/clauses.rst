...
*These use "-ing" or "to" verbs to pack actions tightly into a sentence (highlighted in **bold**).*
...
## 4. Relative Clauses
*These add technical detail to a specific noun using "which" or "that" (highlighted in **bold**).*
...
## 5. Interrupting Clauses (Embedded)
*These drop extra detail or definitions into the middle of a sentence (highlighted in **bold**).*

* **Biology:** Specialized cells—**such as the red blood cell**—are adapted to perform specific functions.
* **Chemistry:** The reaction, **once the catalyst was introduced**, produced bubbles at a much faster rate.
* **Physics:** The total energy of the system—**assuming no energy is lost as heat**—remains constant.
