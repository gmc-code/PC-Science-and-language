...
.. admonition:: Language Features of a Procedure
    ...
    .. tab-set::
        ...
        .. tab-item:: 1. Mood & Agency

            Procedures rely on the **Imperative Mood** to provide clear, direct instructions.

            * **Command Verbs:** Sentences typically begin with a :process:`Process` (verb) rather than a subject.
            * **Elliptical Subject:** The "Actor" (the person doing the work) is omitted because it is understood to be the reader.
            * **Example:** ":process:`Pour` the solution" instead of "You should pour the solution."

        .. tab-item:: 2. Transitivity
