...
Sentences can be categorized based on how many "thoughts" (clauses) are joined together.
...
* **Physics:** The circuit is complete **if the switch is in the "on" position.**
...
.. list-table:: Sentence Types in Science
    :header-rows: 1
    :widths: 20 50 30
